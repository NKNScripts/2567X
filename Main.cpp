...
while(true) wait(1);
	...
	setMotorTarget(Leftdrive,1500,120,true);
	setMotorTarget(Rightdrive, 1500, 120, true);
	while(!getMotorTargetCompleted(Leftdrive) || !getMotorTargetCompleted(Rightdrive)){
	}
	wait(1);*/
